...
public class Entity
{
   ...
   private int health;	
   	...
   	//			ad >= 1
   public Entity(String n, int X, int Y, int velX, int velY, String[][] image, int ad)
   {
      name = n;
      ...
      y = Y;
      health = 100;   
      moveDir = new boolean[2];							//reset movement flags and increments					
